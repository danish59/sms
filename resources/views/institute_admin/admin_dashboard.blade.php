...
@push('styles')
<link type="text/css" rel="stylesheet" href="{{asset('/css/admin-css/chartist.min.css')}}" />
<link type="text/css" rel="stylesheet" href="{{asset('/css/admin-css/jquery.circliful.css')}}">
<link type="text/css" rel="stylesheet" href="{{asset(('/css/admin-css/pages/index.css'))}}">
@endpush
...
@section('content')
    ...
    <div class="outer">
                            ...
                            <div class="row">
                                <div class="col-xs-12 text-xs-center text-white">
                                    <div class="lorem_background">
                                        <div>
                                            <img src="{{asset('/images/admin-images/mailbox_imgs/2.jpg')}}" alt="lorem" class="img-fluid rounded-circle lorem_img">
                                        </div>
                                    ...
                                    <div class="weather_img">
                                        <div class="row header_align">
                                            ...
                                            <div class="icon col-xs-5 col-sm-4">
                                                <img src="{{asset('/images/admin-images/weather1.png')}}" alt="weather" class="img-fluid">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xs-12">
                                                    ...
                                                    <div class="row header_align">
                                                        <div class="col-xs-2 border_right days_margin_top">
                                                            <div class="day text-xs-center">
                                                                ...
                                                                <div>
                                                                    <img src="{{asset('/images/admin-images/w5.png')}}" alt="weather" class="img-fluid">
                                                                </div>
                                                        ...
                                                        <div class="col-xs-2 border_right days_margin_top">
                                                            <div class="day text-xs-center">
                                                                ...
                                                                <div>
                                                                    <img src="{{asset('/images/admin-images/w2.png')}}" alt="weather" class="img-fluid">
                                                                </div>
                                                        ...
                                                        <div class="col-xs-2 border_right days_margin_top">
                                                            <div class="day text-xs-center">
                                                                ...
                                                                <div>
                                                                    <img src="{{asset('/images/admin-images/w3.png')}}" alt="weather" class="img-fluid">
                                                                </div>
                                                        ...
                                                        <div class="col-xs-2 border_right days_margin_top">
                                                            <div class="day text-xs-center">
                                                                ...
                                                                <div>
                                                                    <img src="{{asset('/images/admin-images/w4.png')}}" alt="weather" class="img-fluid">
                                                                </div>
        ...
        <!-- /.outer -->
          ...
          <script type="text/javascript" src="{{asset('/admin-vendor/flip/js/jquery.flip.min.js')}}"></script>
          <script type="text/javascript" src="{{asset('/js/admin-js/pluginjs/jquery.sparkline.js')}}"></script>
          <script type="text/javascript" src="{{asset('/admin-vendor/chartist/js/chartist.min.js')}}"></script>
          <script type="text/javascript" src="{{asset('/js/admin-js/pluginjs/chartist-tooltip.js')}}"></script>
          <script type="text/javascript" src="{{asset('/admin-vendor/swiper/js/swiper.min.js')}}"></script>
          <script type="text/javascript" src="{{asset('/admin-vendor/circliful/js/jquery.circliful.min.js')}}"></script>
          ...
          <!--end of plugin scripts-->
            <script type="text/javascript" src="{{asset('js/admin-js/pages/index.js')}}"></script>
