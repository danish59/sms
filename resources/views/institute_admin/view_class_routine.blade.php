                                ...
                                <tbody id="editable">
                                    ...
                                    @foreach($view_class_routine as $class_routine)
                                        ...
                                        <tr role="row" class="even">
                                            ...
                                            <td>
                                                <a class="edit" data-toggle="tooltip" data-placement="top" title="Edit" onclick="edit_class_routine( {{$class_routine->id}})" href="javascript:;"><i class="fa fa-pencil text-warning"></i></a>&nbsp; &nbsp;
                                                <a class="delete" onclick="delete_class_routine( {{$class_routine->id}})" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash text-danger"></i></a>
                                            </td>
                                        </tr>
                                        @endif
