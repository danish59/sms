        ...
        <div class="main-bar row">
            ...
            <div class="col-lg-6 col-sm-8 col-xs-12">
                <ol class="breadcrumb float-xs-right  nav_breadcrumb_top_align">
                    ...
                    <li class="active breadcrumb-item">Manage Campuses</li>
                </ol>
            </div>
        </div>
    </header>
                    ...
                    <div class="table-toolbar">
                        <div class="btn-group">
                            <button class="btn btn-raised btn-info adv_cust_mod_btn lightspeedin"
                                    data-toggle="modal" data-target="#modal-lightspeedin"><i class="fa fa-plus"></i> Add New Campus
                            </button>
                        ...
                        <div>
                            <table class="table  table-striped table-bordered table-hover dataTable no-footer" id="editable_table" role="grid">
                                ...
                                <tr role="row">
                                    ...
                                    <th class="sorting wid-25" tabindex="0" rowspan="1" colspan="1">Campus Name</th>
                                    <th class="sorting wid-10" tabindex="0" rowspan="1" colspan="1">Principle Name</th>
                                    <th class="sorting wid-20" tabindex="0" rowspan="1" colspan="1">Address</th>
                                    <th class="sorting wid-15" tabindex="0" rowspan="1" colspan="1">Phone</th>
                                ...
                                <tr role="row" class="even">
                                    ...
                                    <td>{{$camp->emp_f_name." ".$camp->emp_m_name." ".$camp->emp_l_name." (".$camp->father_name.")"}}</td>
                                    <?php
                                    $address = $camp->address;
                                    $add = unserialize($address);
                                    ?>
                                    <td class="center"> {{$add['street']." ".$add['city']." ".$add['country']}} </td>
                                    <td class="center">{{$camp->phone_office}}</td>
                                    <td class="center">{{$camp->email}}</td>
                                   <td>
                                        <a href="#{{"dd".$i}}" data-toggle="collapse" aria-expanded="false" aria-controls="collapseExample" title="View"><i class="fa fa-eye text-success"></i></a>&nbsp; &nbsp;
                                        <a class="edit" data-toggle="tooltip" data-placement="top" title="Edit" href="{{url('edit_campus/'.$camp->id)}}"><i class="fa fa-pencil text-warning"></i></a>&nbsp; &nbsp;
                                        <a class="delete" onclick="delete_campus( {{$camp->id}})" href="javascript:;" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash text-danger"></i></a>

                                     <div class="collapse" id="{{"dd".$i}}">
                                       <div class="well">
                                        <table>
                                            <tr>
                                                <td><b>Campus Name</b></td><td>{{$camp->campus_name}}</td>
                                            </tr>
                                            <tr>
                                                <td><b>Principle Name:</b></td><td>{{$camp->emp_f_name." ".$camp->emp_m_name." ".$camp->emp_l_name." (".$camp->father_name.")"}}</td>
                                            </tr>
                                            <tr>
                                                <td><b>Address:</b></td><td>{{$add['street']." ".$add['city']." ".$add['country']}}</td>
                                            </tr>
                                            <tr>
                                                <td><b>Phone:</b></td><td>{{$camp->phone_office}}</td>
                                            </tr>
                                            <tr>
                                                <td><b>Email:</b></td><td>{{$camp->email}}</td>
                                            </tr>
                                        </table>
                                       </div>
                                     </div>
    ...
    {{--<div class="outer">--}}
        ...
        {{--<div class="modal" tabindex="-1" id="modal-zoomin" role="dialog"--}}
            ...
            {{--<div class="modal-dialog" role="document">--}}
                {{--<div class="modal-content">--}}
                    {{--<div class="modal-header bg-success">--}}
                        {{--<h4 class="modal-title text-white" id="modalLabelzoom">Update Campus</h4>--}}
                    {{--</div>--}}
                    {{--<div class="modal-body print-campus">--}}
                    ...
                    {{--<!---row 1 start---->--}}
                        ...
                        {{--<div class="form-group row">--}}
                            ...
                            {{--</div>--}}
                            {{--<div class="col-xl-5">--}}
                                {{--{!! Form:: text('phone_office',null,['placeholder'=>'enter office phone number','id'=>'phone_office','class'=>'form-control']) !!}--}}
                            {{--</div>--}}
                        {{--</div><div class="form-group row">--}}
                            ...
                            {{--</div>--}}
                            {{--<div class="col-xl-5">--}}
                                {{--{!! Form:: email('email',null,['placeholder'=>'enter campus email address','id'=>'email','class'=>'form-control']) !!}--}}
                            {{--</div>--}}
                        {{--</div>--}}
                        {{--<div class="form-group row">--}}
                            {{--<div class="col-xl-3 text-xl-right">--}}
                        ...
                        {{--<div class="form-actions form-group row">--}}
                            {{--<div class="col-xl-8 push-xl-4">--}}
                                {{--<input type="submit" value="Add" class="btn btn-primary add-campus">--}}
                            {{--</div>--}}
                        {{--</div>--}}
                        {{--{!! Form::close() !!}--}}
                    {{--</div>--}}
...
<script type="text/javascript">
    $("body").on("click",".add-campus",function(e){
...
//                alert('Item deleted Successfully.');
                swal({
                    title: "Success.",
                    text: "New Campus Successfully Added",
                    type: "success",
    ...
    function delete_campus(camp_id) {
        $.ajaxSetup({
...
//    function camp_edit(camp_id) {
//        $.ajax({
//            type: 'get',
//            url: '/edit_campus/'+camp_id,
//            datatype:'json',
...
////                    $(".print-campus").find("form").html('');
////                    $.each( campus, function( key, value ) {
////                        $(".print-campus").find("form").append('<input>'+value+'</input>');
////                    });
////                });
//
//            }
