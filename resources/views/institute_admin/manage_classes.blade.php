...
@section('content')
        ...
        <div class="main-bar row">
            ...
            <div class="col-lg-6 col-sm-8 col-xs-12">
                <ol class="breadcrumb float-xs-right  nav_breadcrumb_top_align">
                    ...
                    <li class="active breadcrumb-item">Manage Classes</li>
                </ol>
            </div>
        </div>
    </header>
                                    ...
                                    @foreach($classes as $class)
                                        <tr role="row" class="even">
                                            ...
                                            <td>
                                                ...
                                                <a class="edit" data-toggle="tooltip" data-placement="top" title="Edit" onclick="edit_class( {{$class->id}})" href="javascript:;"><i class="fa fa-pencil text-warning"></i></a>&nbsp; &nbsp;
                                                ...
                                                <div class="collapse" id="{{"class".$i}}">
                                                    <div class="well">
                                                        <table>
                                                            <tr>
                                                                <td><b>Class Name</b></td><td>{{$class->class_name}}</td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                                </div>
    ...
    <div class="modal-content">
    <div class="modal-header bg-success">
    <h4 class="modal-title text-white" id="modalLabelzoom">Update Class</h4>
    </div>
