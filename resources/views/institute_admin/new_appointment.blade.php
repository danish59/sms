    ...
    <div class="outer">
        <div class="inner bg-container">
            <div class="card">
                ...
                {!! Form::open(array('url'=>'/add_employee','id'=>'manage_employee','enctype'=>'multipart/form-data','method'=>'POST','class'=>'form-horizontal login_validator')) !!}
                            ...
                            <div class="form-group row m-t-25">
                                ...
                                <div class="col-xl-6 col-lg-8">
                                    ...
                                    <span class="input-group-addon"> <i class="fa fa-user text-primary"></i>
                                        ...
                                        <input type="text" placeholder="Enter First Name " name="emp_f_name" id="emp_f_name" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row m-t-25">
                                <div class="col-lg-4 text-lg-right">
                                    <label for="u-name" class="form-control-label">Middle Name</label>
                                </div>
                                <div class="col-xl-6 col-lg-8">
                                    <div class="input-group">
                                    <span class="input-group-addon"> <i class="fa fa-user text-primary"></i>
                                    </span>
                                        <input type="text" placeholder="Enter Middle Name " name="emp_m_name" id="emp_m_name" class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row m-t-25">
                                ...
                                <div class="col-xl-6 col-lg-8">
                                    ...
                                    <span class="input-group-addon"> <i class="fa fa-user text-primary"></i>
                                        ...
                                        <input type="text" placeholder="Enter Last Name" name="emp_l_name" id="emp_l_name" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row m-t-25">
                                ...
                                <div class="col-xl-6 col-lg-8">
                                    ...
                                    <span class="input-group-addon"> <i class="fa fa-user text-primary"></i>
                                        ...
                                        <input type="text" placeholder="Enter CNIC" name="emp_cnic" id="emp_cnic" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row m-t-25">
                                ...
                                <div class="col-xl-6 col-lg-8">
                                    ...
                                    <span class="input-group-addon"> <i class="fa fa-user text-primary"></i>
                                        ...
                                        <input type="text" placeholder="Enter Father Name" name="father_name" id="father_name" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row m-t-25">
                            ...
                            <div class="form-group row m-t-25">
                                ...
                                <div class="col-xl-6 col-lg-8">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="date_birth" placeholder="dd/mm/yyyy" data-date-format="dd/mm/yyyy" id="dp2">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-6 col-lg-8">
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Enter Email " id="emp_email" name="emp_email"
                                               class="form-control">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="tel" name="emp_phone" class="form-control" id="emp_phone" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                    {{--<div class="form-group row">--}}
                            ...
                            <div class="col-xs-6">
                                <div class="form-group row m-t-25">
                                    ...
                                    <span class="input-group-addon"> <i class="fa fa-user text-primary"></i>
                                            ...
                                            <input type="text" placeholder="Enter Degree Title" name="degree_certificate" id="degree_certificate" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row m-t-25">
                                    ...
                                    <span class="input-group-addon"> <i class="fa fa-user text-primary"></i>
                                            ...
                                            <input type="text" placeholder="Enter CGPA or percentage" name="cgpa_percentage" id="cgpa_percentage" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row m-t-25">
                            ...
                            <div class="col-xs-6">
                                <div class="form-group row m-t-25">
                                    <div class="col-lg-5 text-lg-right">
                                        <label for="u-name" class="form-control-label">Other Certificates/Courses </label>
                                    </div>
