                ...
                <div id="top">
                    ...
                    <nav class="navbar navbar-static-top">
                        <div class="container-fluid">
                            <a class="navbar-brand text-xs-center" href="{{asset('index.html')}}">
                                <h3><img src="{{asset('/images/admin-images/logo1.ico')}}" class="admin_img" alt="logo">Paradise Creative School</h3>
                            </a>
                            <div class="menu">
                        ...
                        <div class="menu_scroll">
                            ...
                            <ul id="menu">
                                ...
                                {{--<li class="dropdown_menu">--}}
                                    ...
                                    {{--<ul>--}}
                                        {{--<li>--}}
                                            {{--<a href="{{URL('/admin_general_components')}}">--}}
                                        ...
                                        {{--<li>--}}
                                            {{--<a href="jstree.html">--}}
                                                {{--<i class="fa fa-angle-right"></i>--}}
                                                {{--&nbsp;Js Tree<span class="tag tag-pill tag-success new_tag">New</span>--}}
                                            {{--</a>--}}
                                        {{--</li>--}}
                                        {{--<li>--}}
                                            {{--<a href="modal.html">--}}
                                ...
                                <li class="dropdown_menu">
                                    <a href="javascript:;">
                                        <i class="fa fa-anchor"></i>
                                        <span class="link-title menu_hide">&nbsp;Manage Initials</span>
                                        <span class="fa arrow menu_hide"></span>
                                    </a>
                                    <ul>
                                        <li>
                                        ...
                                        <li>
                                            <a href="{{URL('/manage_class_incharge')}}">
                                                <i class="fa fa-angle-right"></i>
                                ...
                                <li class="dropdown_menu">
                                    ...
                                    <ul class="sub-menu">
                                        <li>
                                            <a href="javascript:;">
                                                <i class="fa fa-angle-right"></i>
                                                &nbsp;<span class="link-title menu_hide">&nbsp;Admissions</span>
                                                <span class="fa arrow menu_hide"></span>
                                            </a>
                                ...
                                <li class="dropdown_menu">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="{{url('/manage_fee_structure')}}">
                                                <i class="fa fa-angle-right"></i>
                                                &nbsp; Manage Fee Structue
                                            </a>
                                        </li>
                                ...
                                <li class="dropdown_menu">
                                    <a href="javascript:;">
                                        <i class="fa fa-th-large"></i>
                                        <span class="link-title menu_hide">&nbsp; User's </span>
                                        <span class="fa arrow menu_hide"></span>
                                    </a>
                                    <ul>
                                        <li>
                                            <a href="{{url('/user_teachers')}}">
                                                <i class="fa fa-angle-right"></i>
                                                &nbsp; Teacher's
                                            </a>
                                        </li>
                                ...
                                <li class="dropdown_menu">
                                    <a href="javascript:;">
                                        <i class="fa fa-th-large"></i>
                                        <span class="link-title menu_hide">&nbsp; Employees</span>
                                        <span class="fa arrow menu_hide"></span>
                                    </a>
                                    <ul>
                                        <li>
                                    ...
                                    {{--<ul>--}}
                                        ...
                                        {{--<li>--}}
                                            {{--<a href="simple_datatables.html">--}}
                                                {{--<i class="fa fa-angle-right"></i>--}}
                                                {{--<span class="link-title">&nbsp; Simple Data Tables <span class="tag tag-pill tag-success new_tag">New</span></span>--}}
                                            {{--</a>--}}
                                        {{--</li>--}}
                                        {{--<li>--}}
