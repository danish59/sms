            ...
            <div class="col-lg-5">
                ...
                <div class="row">
                    <div class="col-lg-12" align="center">
                        <b><u><label for="date">Date:&rarr;</label>{{$DAY."/".$date}}</u></b>
                    </div>
                </div>
    ...
    <div class="outer bg-container" id="class_all_students">
        <div class="card">
            <div class="card-block m-t-35 class-students-form">
                {!! Form::open(array('class'=>'ajax','id'=>'upload_attendance','url'=>'/upload_attendance','method'=>'POST')) !!}
                <meta name="_token" content="{{ csrf_token() }}">
                <div class="alert alert-danger print-error-msg" style="display:none">
                    <ul></ul>
                </div>
                <input type="hidden" value="{{$employee->section_id}}" name="hidden_section_id">
                <input type="hidden" value="{{$DAY}}" name="hidden_day">
                <input type="hidden" value="{{$date}}" name="hidden_date">
                <div class="form-group row">
                    ...
                    <div class="col-xl-12"><b>
                            <div class="form-group row">
                                ...
                                <div class="col-xl-3">
                                    <?php echo Form::label('attendance', 'Attendance', ['class' => 'form-control-label'])?>
                                </div>
                            </div></b>
                    </div>
                    </div>
            ...
            @foreach($class_students as $student)
                    ...
                    <div class="form-group row">
                    <div class="col-xl-3 text-xl-center">
                        <label for="roll_no">{{$student->roll_no}}</label>
                        <input type="hidden" name="{{'roll_no'.$j}}" class="form-control" value="{{$student->roll_no}}">
                        </div>
                    <div class="col-xl-3">
                        <label for="std_name">{{$student->std_name}}</label>
                        <input type="hidden" name="{{'student_name'.$j}}" class="form-control" value="{{$student->std_name}}">
                        </div>
                    <div class="col-xl-3">
                        <label for="father_name">{{$student->father_name}}</label>
                        <input type="hidden" name="{{'father_name'.$j}}" class="form-control" value="{{$student->father_name}}">
                        </div>
                    <div class="col-xl-3">
                        <div class="radio">
                            <label class="text-success">
                                <input name="status{{$j}}" value="1" type="radio" checked>
                                <span class="cr"><i class="cr-icon fa fa-circle"></i></span>
                                Present
                            </label>
                            <label class="text-danger">
                                <input name="status{{$j}}" value="0" type="radio">
                                <span class="cr"><i class="cr-icon fa fa-circle"></i></span>
                                Absent
                            </label>
                        </div>
        ...
        <div class="form-actions form-group row">
            <div class="col-xl-12 text-xl-center">
                <input type="submit" value="Upload" class="btn btn-primary upload_attendance">
            </div>
        </div>
        {!! Form::close() !!}
...
@push('scripts')
    ...
    <script type="text/javascript">
        $("body").on("click",".upload_attendance",function(e){
            $(this).parents("form").ajaxForm(uploadAttendence);
        });

        var uploadAttendence = {
