...
@push('styles')
<link type="text/css" rel="stylesheet" href="{{asset('/css/admin-css/c3.min.css')}}"/>
<link type="text/css" rel="stylesheet" href="{{asset('/css/admin-css/toastr.min.css')}}"/>
<link type="text/css" rel="stylesheet" href="{{asset('/css/admin-css/switchery.min.css')}}"/>
<link type="text/css" rel="stylesheet" href="{{asset('/css/admin-css/pages/new_dashboard.css')}}"/>
@endpush
                                        ...
                                        <div class="col-xs-12">
                                            ...
                                            <div class="row weekly_report">
                                                <div class="col-xs-3">
                                                    <span>Mon</span>
                                                    <br/>
                                                    <img src="{{asset('/images/admin-images/w1.png')}}" alt="weather">
                                                    <p>27&deg;</p>
                                                </div>
                                                <div class="col-xs-3">
                                                    <span>Tue</span>
                                                    <br/>
                                                    <img src="{{asset('/images/admin-images/w2.png')}}" alt="weather">
                                                    <p>23&deg;</p>
                                                </div>
                                                <div class="col-xs-3">
                                                    <span>Wed</span>
                                                    <br/>
                                                    <img src="{{asset('/images/admin-images/w3.png')}}" alt="weather">
                                                    <p>19&deg;</p>
                                                </div>
                                                <div class="col-xs-3">
                                                    <span>Thu</span>
                                                    <br/>
                                                    <img src="{{asset('/images/admin-images/w4.png')}}" alt="weather">
                                                    <p>38&deg;</p>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <ul class="Browser_stats_ul">
                                        <li><span><img alt="google" src="{{asset('/images/admin-images/chrome.png')}}"/>Google Crome</span><span
                                                    class="float-xs-right text-mint">32%<i
                                                        class="fa fa-level-up"></i></span>
                                            <hr/>
                                        </li>
                                        <li><span><img alt="firebox" src="{{asset('/images/admin-images/firefox.png')}}">Firefox</span><span
                                                    class="float-xs-right text-danger">5%<i
                                                        class="fa fa-level-down"></i></span>
                                            <hr/>
                                        </li>
                                        <li><span><img alt="safari" src="{{asset('/images/admin-images/safari2.png')}}">Safari</span><span
                                                    class="float-xs-right text-mint">10%<i
                                                        class="fa fa-level-up"></i></span>
                                            <hr/>
                                        </li>
                                        <li><span><img alt="opera" src="{{asset('/images/admin-images/opera.png')}}">Opera</span><span
                                                    class="float-xs-right text-mint">32%<i
                                                        class="fa fa-level-up"></i></span>
                                            <hr/>
                                        </li>
                                        <li><span><img alt="ie" src="{{asset('/images/admin-images/Ie.png')}}">IE</span><span
                                                    class="float-xs-right text-danger">15%<i
                                                        class="fa fa-level-down"></i></span>
                                            <hr/>
                                        </li>
                                        <li><span><img alt="mobile" src="{{asset('/images/admin-images/mobile1.png')}}">Mobile</span><span
                                                    class="float-xs-right text-mint">32%<i
                                                        class="fa fa-level-up"></i></span>
                                            <hr/>
                                        </li>
                                        <li><span><img alt="others" src="{{asset('/images/admin-images/others.png')}}">Others</span><span
                                                    class="float-xs-right text-mint">32%<i
                                ...
                                <div class="card-block twitter_section">
                                    <ul id="nt-example1">
                                        <li>
                                            <div class="row">
                                                <div class="col-xs-2 col-lg-3 col-xl-2">
                                                    <img src="{{asset('/images/admin-images/images.jpg')}}" class="rounded-circle"
                                                         alt="image not found">
                                                </div>
                                        ...
                                        <li>
                                            <div class="row">
                                                <div class="col-xs-2 col-lg-3 col-xl-2">
                                                    <img src="{{asset('/images/admin-images/images3.jpg')}}" class="rounded-circle"
                                                         alt="image not found">
                                                </div>
                                                <div class="col-xs-10 col-lg-9 col-xl-10">
                                        ...
                                        <li>
                                            <div class="row">
                                                <div class="col-xs-2 col-lg-3 col-xl-2">
                                                    <img src="{{asset('/images/admin-images/images2.jpg')}}" class="rounded-circle"
                                                         alt="image not found">
                                                </div>
                                                <div class="col-xs-10 col-lg-9 col-xl-10">
                                        ...
                                        <li>
                                            <div class="row">
                                                <div class="col-xs-2 col-lg-3 col-xl-2">
                                                    <img src="{{asset('/images/admin-images/images4.jpg')}}" class="rounded-circle"
                                                         alt="image not found">
                                                </div>
                                                <div class="col-xs-10 col-lg-9 col-xl-10">
...
@push('scripts')
<!--  plugin scripts -->
<script type="text/javascript" src="{{asset('/admin-vendor/slimscroll/js/jquery.slimscroll.min.js')}}"></script>
<script type="text/javascript" src="{{asset('/admin-vendor/raphael/js/raphael-min.js')}}"></script>
<script type="text/javascript" src="{{asset('/admin-vendor/d3/js/d3.min.js')}}"></script>
<script type="text/javascript" src="{{asset('/admin-vendor/c3/js/c3.min.js')}}"></script>
<script type="text/javascript" src="{{asset('/admin-vendor/toastr/js/toastr.min.js')}}"></script>
<script type="text/javascript" src="{{asset('/admin-vendor/switchery/js/switchery.min.js')}}"></script>
<script type="text/javascript" src="{{asset('/admin-vendor/flotchart/js/jquery.flot.js')}}"></script>
<script type="text/javascript" src="{{asset('/admin-vendor/flotchart/js/jquery.flot.resize.js')}}"></script>
<script type="text/javascript" src="{{asset('/admin-vendor/flotchart/js/jquery.flot.stack.js')}}"></script>
<script type="text/javascript" src="{{asset('/admin-vendor/flotchart/js/jquery.flot.time.js')}}"></script>
<script type="text/javascript" src="{{asset('/admin-vendor/flotspline/js/jquery.flot.spline.min.js')}}"></script>
<script type="text/javascript" src="{{asset('/admin-vendor/flotchart/js/jquery.flot.categories.js')}}"></script>
<script type="text/javascript" src="{{asset('/admin-vendor/flotchart/js/jquery.flot.pie.js')}}"></script>
<script type="text/javascript" src="{{asset('/admin-vendor/flot.tooltip/js/jquery.flot.tooltip.min.js')}}"></script>
<script type="text/javascript" src="{{asset('/admin-vendor/jquery_newsTicker/js/newsTicker.js')}}"></script>
<script type="text/javascript" src="{{asset('/admin-vendor/countUp.js/js/countUp.min.js')}}"></script>
<!--end of plugin scripts-->

<script type="text/javascript" src="{{asset('/js/admin-js/pages/new_dashboard.js')}}"></script>
@endpush