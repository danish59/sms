...
@section('content')
    ...
    <header class="head">
        <div class="main-bar row">
            ...
            <div class="col-lg-5">
                {!! Form::open(array('class'=>'ajax','url'=>'/ajax_form_view_result','id'=>'ajax_form_view_result','enctype'=>'multipart/form-data','method'=>'POST')) !!}
                <meta name="csrf-token" content="{{ csrf_token() }}">
                ...
                <div class="form-group row m-t-25">
                    ...
                    <div class="col-xl-3 col-lg-3">
                        <div class="input-group">
                            <button class="btn btn-primary view_result" type="submit">
...
@push('scripts')
    ...
    <script type="text/javascript">
        $("body").on("click",".view_result",function(e){
            $(this).parents("form").ajaxForm(ViewResult);
        });
        var ViewResult = {
...
//                $(".registration-form").html(
                        form_print =
                            ...
                            '</div>'+
                            '<div class="col-xl-2">'+
                            '<?php echo Form::label('total_marks', 'Total Marks', ['class' => 'form-control-label'])?>' +
                            '</b></div>'+
                            '</div>'+
                            '<hr class="alert-info">';
                        var j = 0;
                        for (var i = 0; i < class_students.length; i++) {
                            ...
                            form_print += '<div class="form-group row">' +
                                ...
                                '</div>'+
                                '<div class="col-xl-2">'+
                                '<label for="father_name">'+class_students[i].obtained_marks +'</label>'+
                                '</div>'+
                                '<div class="col-xl-2">'+
                                '<label for="father_name">'+class_students[i].total_marks +'</label>'+
                                '</div>'+
                                '</div>'+
                                '<hr class="#f3f6db">';
